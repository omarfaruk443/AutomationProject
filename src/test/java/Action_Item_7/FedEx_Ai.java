...
public class FedEx_Ai extends Abstract_Class {
    ...
    public void fedEx() throws InterruptedException, AWTException {
        ...
        Reusable_Methods_Loggers.uploadFileCustom("C:\\Users\\oshuv\\Videos\\Captures\\screenshot.png",logger);
        Thread.sleep(20000);
        ...
        //sometime there might be a popup, lets close it
        Reusable_Methods_Loggers.mouseClickPopUpByIndex(driver,"//*[@shape='rect']",0,logger,"PopUp");
        //hit ok on popup if its saying address not available at this time
